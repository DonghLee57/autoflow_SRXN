...
# Add src to sys.path
from autoflow_srxn.vibrational_analyzer import calculate_atomic_participation, calculate_mac
...
def run_visualization():
    ...
    print("Saved: plot_freq_parity.png")
    ...
    print("Saved: plot_participation.png")
