...
def run_physisorption_vibration_test():
    ...
    with open(report_path, "w") as f:
        ...
        f.write("System: DIPAS on SiO2 (001) slab\n")
        f.write("Slab: 1x1x1 unit cell, H-passivated, bottom fixed\n")
        f.write("Potential: MACE (small)\n")
        f.write("Relaxation: Stage 1 (0.05) + Stage 2 (0.01)\n\n")
        f.write("## Results\n")
